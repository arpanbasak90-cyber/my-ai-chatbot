...
export default function Home() {
  ...
  return (
    <div className={`relative min-h-[100dvh] w-full flex flex-col items-center justify-between p-2 sm:p-6 transition-colors duration-300 overflow-x-hidden ${theme === "dark" ? "bg-[#0b0f17] text-slate-100" : "bg-white text-slate-900"
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <div className="relative" ref={voiceMenuRef}>
            <button
              ...
              className={`flex items-center space-x-1 px-2 py-1.5 sm:px-3 sm:py-2 rounded-xl text-[10px] sm:text-xs font-semibold border transition-all duration-300 outline-none ${theme === "dark"
            ...
            {isVoiceMenuOpen && (
              <div
                className={`fixed left-3 right-3 top-16 sm:absolute sm:top-auto sm:right-0 sm:left-auto mt-2 w-auto sm:w-64 max-h-[60vh] sm:max-h-72 overflow-y-auto rounded-2xl p-1.5 shadow-2xl z-[100] backdrop-blur-xl border scrollbar-thin ${theme === "dark"
          ...
          <div className="relative" ref={langMenuRef}>
            ...
            >
              ...
              />
              <span className="truncate max-w-[55px] sm:max-w-none">{currentLang.nativeName}</span>
              <svg
          ...
          <button
            ...
            className={`flex items-center space-x-1 px-2 py-1.5 sm:px-3 sm:py-2 rounded-xl text-[10px] sm:text-xs font-semibold border transition-all duration-300 ${theme === "dark"
          ...
          >
            ...
            <span className="hidden min-[430px]:inline">History</span>
          </button>
      ...
      <main className="relative z-10 w-full max-w-4xl flex-1 flex flex-col justify-between my-3 sm:my-6 overflow-hidden min-h-0">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center text-center space-y-4 sm:space-y-6 my-auto px-2 py-4">
            ...
            <div className="relative group">
              ...
              <div className={`relative w-28 h-28 sm:w-44 sm:h-44 rounded-full border-2 p-3 flex items-center justify-center shadow-2xl backdrop-blur-xl transition-all duration-300 ${theme === "dark"
            ...
            <div className="max-w-xl space-y-2 sm:space-y-3">
              <h2 className={`text-3xl sm:text-6xl font-black tracking-tight pb-1 sm:pb-2 inline-block leading-normal bg-clip-text text-transparent ${theme === "dark"
          ...
          <div className="space-y-4 sm:space-y-6 overflow-y-auto max-h-[calc(100dvh-180px)] sm:max-h-[65vh] pr-1 sm:pr-2 scrollbar-thin">
            {messages.map((m, i) => (
              <div
                key={i}
                className={`flex flex-col p-3.5 sm:p-5 rounded-2xl transition-all duration-300 ${m.role === "user"
                  ? "bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 text-white ml-auto max-w-[92%] sm:max-w-[85%] shadow-xl glow-blue rounded-br-none"
                  : theme === "dark"
                    ? "bg-slate-900/90 border border-cyan-500/30 text-slate-100 mr-auto max-w-[95%] sm:max-w-[90%] glass-panel shadow-2xl rounded-bl-none backdrop-blur-xl"
                    : "bg-white border border-slate-200/90 text-slate-900 mr-auto max-w-[95%] sm:max-w-[90%] shadow-md rounded-bl-none"
                  }`}
              >
            ...
            {loading && (
              <div
                className={`p-4 sm:p-5 rounded-2xl mr-auto max-w-[95%] sm:max-w-[90%] border backdrop-blur-xl ${theme === "dark"
      ...
      <footer className="relative z-20 w-full max-w-4xl pb-2 pt-1 shrink-0">
        {isListening && (
        ...
        <form onSubmit={handleSearch} className="relative flex items-center">
          ...
          <div className="relative w-full group">
            ...
            <input
              ...
              className={`relative w-full py-3 sm:py-4 pl-9 sm:pl-12 pr-20 sm:pr-28 rounded-full text-xs sm:text-sm font-normal transition-all duration-300 outline-none backdrop-blur-xl ${theme === "dark"
            ...
            <button
              ...
              disabled={loading}
              className={`absolute right-10 sm:right-14 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-9 sm:h-9 rounded-full p-1 border transition-all duration-300 flex items-center justify-center ${isListening
            ...
            <button
              ...
              className="absolute right-1.5 sm:right-2.5 top-1/2 -translate-y-1/2 p-2 sm:p-3 rounded-full bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 text-white hover:from-indigo-500 hover:to-cyan-400 transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed shadow-md glow-cyan"
              title="Execute Query"
            >
      ...
      {isHistoryOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end bg-black/60 backdrop-blur-sm transition-opacity">
          <div
            className={`w-full sm:max-w-md h-full flex flex-col shadow-2xl border-l p-4 sm:p-5 overflow-hidden transition-all transform duration-300 ${theme === "dark"
